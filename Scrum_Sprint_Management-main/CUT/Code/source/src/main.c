...
int main()
{
	...
	while(ch!=0)
	{
		...
		if (ch==1)
		{
			...
			if (userBelonging==-1)
			{
				printf("\nEither Scrum Master id or password is incorrect!\n");
				continue;
			}
				...
				while(tlChoice1!=0)
				{
					...
					else if(tlChoice1==2)
					{
						...
						if (res==0){
							...
							if(completionStatus<0 || completionStatus>100)
						        {
								printf("\n");																                                    printf("WARNING : Completion status cannot be more than 100 or less than 0 ");
								printf("\n");
								continue;
							}
							printf("\nEnter Story Name:");
					...
					else if(tlChoice1==3)
					{
						...
						if (res==0){
							...
							if(completionStatusTask<0 || completionStatusTask>100)
							{
								printf("\n");
								printf("WARNING : Completion status cannot be more than 100 or less than 0 ");
								printf("\n");
				...
				while(tlchoice2!=0)
				{
					...
					else if (tlchoice2==2)
					{
						...
						if (res==0){
							...
							{
								printf("\n");
								printf(" WARNING : NEW completion status cannot be more than 100 and less than 0 ");
								printf("\n");
								continue;
							}
